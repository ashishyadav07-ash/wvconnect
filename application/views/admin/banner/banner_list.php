    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            ...
            <div class="widgetbar">
                ...
                <a href="<?= base_url('admin/banner/add_edit'); ?>"><button class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add New Banner</button></a>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    ...
    "ajax": "<?=base_url('admin/banner/datatable_json')?>",

    "order": [[0,'desc']],

    "columnDefs": [

    { "targets": 0, "name": "bannerID", 'searchable':true, 'orderable':true,'width':'50px'},
    
    { "targets": 1, "name": "bannerImage", 'searchable':true, 'orderable':true,'width':'100px'},

    { "targets": 2, "name": "bannerImageMobile", 'searchable':true, 'orderable':true,'width':'100px'},

    { "targets": 3, "name": "bannerTitle", 'searchable':true, 'orderable':true,'width':'100px'},
...
<script type="text/javascript">
  ...
  $("body").on("change",".tgl_checkbox",function(){
    ...
    $.post('<?=base_url("admin/banner/change_status")?>',
...
<script type="text/javascript">
  ...
  $("body").on("change",".delete",function(){
    ...
    $.post('<?=base_url("admin/banner/banner_delete")?>',
