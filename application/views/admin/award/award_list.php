...
<div class="breadcrumbbar">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-8 col-lg-8">
            ...
            <h4 class="page-title">Awards List</h4>
        ...
        <div class="col-md-4 col-lg-4">
            ...
            <div class="widgetbar">
                ...
                <a href="<?= base_url('admin/award/add_edit'); ?>"><button class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add New Award</button></a>
        ...
        <div class="col-lg-12">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-title">Awards List</h5>
                </div>
...
<script>
  ...
  var table = $('#na_datatable').DataTable({
    ...
    "ajax": "<?=base_url('admin/award/datatable_json')?>",
...
<script type="text/javascript">
  ...
  $("body").on("change",".tgl_checkbox",function(){
    ...
    $.post('<?=base_url("admin/award/change_status")?>',
...
S
    $.post('<?=base_url("admin/award/award_delete")?>',
