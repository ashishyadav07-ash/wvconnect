<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="<?= base_url(); ?>admin/jury"><button class="btn btn-primary-rgba"> <i
                            class="feather icon-list mr-2"></i>Jury List</button></a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="nomineeID" id="nomineeID"
                        value="<?php echo isset($Fetch_data['nomineeID']) ? set_value("nomineeID", $Fetch_data['nomineeID']) : set_value("nomineeID"); ?>">
                    <input type="hidden" name="jury_assignID" id="jury_assignID"
                        value="<?php echo isset($Fetch_data['jury_assignID']) ? set_value("jury_assignID", $Fetch_data['jury_assignID']) : set_value("jury_assignID"); ?>">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="awardCategory"><span class="text-danger">*</span>Award Category</label>
                            <select name="awardCategory" readonly disabled class="form-control" id="awardCategory"
                                placeholder="">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="remark" class="form-control" id="remark" placeholder="">
                                <option selected disabled value="">Select Remark</option>
                                <option value="1" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '1' == $Fetch_data['remark']) ? "selected" : ''; ?>>01</option>
                                <option value="2" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '2' == $Fetch_data['remark']) ? "selected" : ''; ?>>02</option>
                                <option value="3" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '3' == $Fetch_data['remark']) ? "selected" : ''; ?>>03</option>
                                <option value="4" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '4' == $Fetch_data['remark']) ? "selected" : ''; ?>>04</option>
                                <option value="5" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '5' == $Fetch_data['remark']) ? "selected" : ''; ?>>05</option>
                                <option value="6" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '6' == $Fetch_data['remark']) ? "selected" : ''; ?>>06</option>
                                <option value="7" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '7' == $Fetch_data['remark']) ? "selected" : ''; ?>>07</option>
                                <option value="8" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '8' == $Fetch_data['remark']) ? "selected" : ''; ?>>08</option>
                                <option value="9" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '9' == $Fetch_data['remark']) ? "selected" : ''; ?>>09</option>
                                <option value="10" <?php echo (isset($Fetch_data['remark']) && $Fetch_data['remark'] != '' && '10' == $Fetch_data['remark']) ? "selected" : ''; ?>>10</option>
                    ...
                    <div class="form-row">
                        ...
                        <?php } ?>
                        <div class="form-group col-md-6">
                            <label for="comments"><span class="text-danger">*</span>Comments</label>
                            <textarea type="text" autocomplete="off" name="comments" class="form-control" id="comments"
                                value="<?php echo isset($Fetch_data['comments']) ? set_value("comments", $Fetch_data['comments']) : set_value("comments"); ?>"
                                placeholder=""> <?php echo $Fetch_data['comments']; ?></textarea>
                        </div>
